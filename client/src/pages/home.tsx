...
export default function Home() {
  ...
  const handleCategorySelect = (category: Category) => {
    ...
    // Aqui você pode implementar a lógica para iniciar o quiz
    // Por exemplo: setLocation(`/quiz?category=${category.slug}`);
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {categories.map((category) => {
                ...
                return (
                  <Card 
                    key={category.id} 
                    className={`group transition-all duration-300 border-0 bg-white relative overflow-hidden ${
                      isAvailable 
